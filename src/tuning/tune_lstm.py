...
def build_lstm(num_layers, units_per_layer, dropout_rate, batch_normalization):
    model = Sequential()
    for i in range(num_layers):
        model.add(LSTM(units_per_layer, return_sequences=(i < num_layers - 1)))
